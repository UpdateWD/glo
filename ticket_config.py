...
admin = 1353097202 # ID Админа
support = 1353097202 # ID сапорта
channel_id = -1001219934403 # ID Канала залётов
chat_worker_id = -1001261569575 # ID Чата с воркерами

bot_name = 'golbol_bot' # Username Бота

mater = '1' # Ссылка на мануалы
zalet = '1' # Ссылка на канал с залётами
infos = '1' # Ссылка на инфо канал
pname = '1' # Название проекта
pdate = '1' # Дата созданя проекта
